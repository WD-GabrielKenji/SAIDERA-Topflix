...
import analiseSVG from './icons/icon/analise.svg';
...
import anFilme from './analise/AnaliseFilm.jpeg';
import anSerie from './analise/AnaliseSerie.jpeg';
import graficoSVG from '../assets/icons/icon/grafico.svg';
import clickSVG from '../assets/icons/icon/click.svg';
import clickSVG2 from '../assets/icons/icon/clickk.svg';

export const logoSVG = logo;
export const HomeLogo = Hlogo;

export const infoIcon = infoSVG;
export const goalIcon = goalSVG;
...
export const iconKOR = KorSVG;
export const iconCAN = CanSVG;
export const iconJP = JpSVG;
export const analiseIcon = analiseSVG;
...
export const analiseFilm = anFilme;
export const analiseSerie = anSerie;
export const graficoIcon = graficoSVG;
export const clickIcon = clickSVG;
export const click2Icon = clickSVG2;